      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition">
            ...
            <p className="text-3xl font-bold text-gray-900 mb-1">{stats.sharedNotes}</p>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition">
            ...
            <p className="text-3xl font-bold text-gray-900 mb-1">{stats.todayNotes}</p>
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-8 mb-8 shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-indigo-100 mb-4">Capture your ideas and collaborate with others</p>
              <button
                onClick={onCreateNote}
                className="bg-white text-indigo-600 hover:bg-indigo-50 font-semibold py-3 px-6 rounded-xl transition shadow-md hover:shadow-lg"
              >
                Create New Note
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recentNotes.map((note) => (
                <div
                  ...
                  className="bg-white rounded-xl border border-gray-200 p-6 cursor-pointer hover:shadow-lg hover:border-indigo-300 transition-all group"
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    {note.collaborators && note.collaborators.length > 0 && (
                      <div className="ml-2 flex-shrink-0 bg-purple-100 rounded-lg p-1.5">
