    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          <div className="w-20 h-20 mx-auto mb-4 bg-slate-100 dark:bg-gray-700 rounded-2xl flex items-center justify-center transition-colors">
            <svg className="w-10 h-10 text-slate-300 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
          </div>
          <h3 className="text-lg font-semibold text-slate-700 dark:text-gray-300 mb-1">No notes yet</h3>
          <p className="text-sm text-slate-500 dark:text-gray-500">Create your first note to get started</p>
        </div>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {notes.map((note) => (
          <div
            ...
            className="group bg-white dark:bg-gray-800 rounded-3xl border-2 border-gray-200 dark:border-gray-700 p-5 cursor-pointer transition-all hover:shadow-2xl hover:shadow-indigo-100 dark:hover:shadow-indigo-900/20 hover:border-indigo-300 dark:hover:border-indigo-600 hover:-translate-y-1 relative"
          >
            ...
            <div>
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-2 flex-1">
                  {note.isPinned && (
                    <div className="bg-yellow-50 dark:bg-yellow-900/30 rounded-lg p-1 flex-shrink-0 transition-colors">
                      <svg className="w-3.5 h-3.5 text-yellow-600 dark:text-yellow-400" fill="currentColor" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {note.collaborators && note.collaborators.length > 0 && (
                  <div className="bg-purple-50 dark:bg-purple-900/30 rounded-lg p-1.5 flex-shrink-0 ml-2 transition-colors">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 line-clamp-3 mb-2 leading-relaxed min-h-[63px]">
                {stripHtml(note.content) || 'No content'}
              </p>
              
              {/* Action Buttons */}
              <div className="flex items-center justify-center gap-1.5 mb-3 pb-3 border-b border-gray-100 dark:border-gray-700 transition-colors">
                {onTogglePin && (
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                    ...
                    className={`w-7 h-7 hover:scale-110 rounded-lg flex items-center justify-center transition-all ${
                      note.isPinned 
                        ...
                        : 'bg-gray-50 dark:bg-gray-700 text-gray-400 dark:text-gray-500 hover:bg-yellow-50 dark:hover:bg-yellow-900/30 hover:text-yellow-600 dark:hover:text-yellow-400'
                    }`}
                ...
                <button
                  ...
                  className="w-7 h-7 bg-indigo-50 dark:bg-indigo-900/40 hover:bg-indigo-200 dark:hover:bg-indigo-900/60 hover:scale-110 text-indigo-600 dark:text-indigo-400 rounded-lg flex items-center justify-center transition-all"
                  title="Edit note"
                >
                ...
                {onShareNote && (
                  <button
                    ...
                    className="w-7 h-7 bg-purple-50 dark:bg-purple-900/40 hover:bg-purple-200 dark:hover:bg-purple-900/60 hover:scale-110 text-purple-600 dark:text-purple-400 rounded-lg flex items-center justify-center transition-all"
                    title="Share note"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {onAddToFolder && !note.folder && (
                  <button
                    ...
                    className="w-7 h-7 bg-green-50 dark:bg-green-900/40 hover:bg-green-200 dark:hover:bg-green-900/60 hover:scale-110 text-green-600 dark:text-green-400 rounded-lg flex items-center justify-center transition-all"
                    title="Add to folder"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {onDeleteNote && (
                  <button
                    ...
                    className="w-7 h-7 bg-red-50 dark:bg-red-900/40 hover:bg-red-200 dark:hover:bg-red-900/60 hover:scale-110 text-red-600 dark:text-red-400 rounded-lg flex items-center justify-center transition-all"
                    title="Delete note"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {showRemoveButton && onRemoveFromFolder && (
                  <button
                    ...
                    className="w-7 h-7 bg-orange-50 dark:bg-orange-900/40 hover:bg-orange-200 dark:hover:bg-orange-900/60 hover:scale-110 text-orange-600 dark:text-orange-400 rounded-lg flex items-center justify-center transition-all"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 dark:bg-black dark:bg-opacity-70 flex items-center justify-center p-4 z-50 transition-colors">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-6 transition-colors">
            <div className="flex items-start gap-4 mb-6">
              <div className="w-12 h-12 bg-red-100 dark:bg-red-900/40 rounded-full flex items-center justify-center flex-shrink-0 transition-colors">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 font-semibold rounded-xl transition"
              >
                Cancel
              </button>
              <button
