      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {notes.map((note) => (
          <div
            ...
            className="group bg-gradient-to-br from-white to-gray-50 rounded-2xl border-2 border-gray-200 p-6 cursor-pointer transition-all hover:shadow-2xl hover:border-indigo-400 hover:-translate-y-2 relative overflow-hidden"
          >
            {/* Decorative gradient overlay */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-full blur-3xl opacity-0 group-hover:opacity-50 transition-opacity -z-0"></div>
            ...
            <div className="relative z-10">
              <div className="flex items-start justify-between mb-4">
                <h3 className="font-bold text-gray-900 text-xl truncate flex-1 group-hover:text-indigo-600 transition pr-2">
                  {note.title || 'Untitled'}
                </h3>
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <button
                    ...
                    className="w-9 h-9 bg-indigo-100 hover:bg-indigo-200 text-indigo-600 rounded-lg flex items-center justify-center transition opacity-0 group-hover:opacity-100"
                    title="Edit note"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
