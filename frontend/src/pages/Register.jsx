      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center mb-3">
            <img src="/logo.png" alt="Notely Logo" className="w-20 h-20 object-contain" />
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Start organizing your notes today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                minLength={6}
              />
              <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">Must be at least 6 characters</p>
            </div>
